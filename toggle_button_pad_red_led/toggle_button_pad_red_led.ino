...
static const uint8_t btncolumnpins[NUM_BTN_COLUMNS] = {2,3,4,5}; //46,47,48,49 //Switch 1,2,3,4
static const uint8_t btnrowpins[NUM_BTN_ROWS]       = {21,20,19,18}; //50,51,52,53 //SWT-GND 4,3,2,1
...
//    Serial.println(val);
    if (val == LOW)
    {
      ...
      {
        Serial.println(debounce_count[current][j]);
